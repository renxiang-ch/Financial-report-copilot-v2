...
| 007 | Phase 3 — 框架能力成熟化（持久化 / 可观测 / 降级 / grounding 回边 / 按需澄清） | active | [007](007-phase3-maturity.md) | 3.1 跨进程续答 ✅ · 3.3 模型降级 ✅ · 3.4 回边代码+单测 ✅（评测上 no-op）· 3.2 卡凭据 · 3.5 设计待定；pytest 173/0 |
